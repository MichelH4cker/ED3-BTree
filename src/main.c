...
void menu(){
    ...
    // LOCAL
    char path_data[50] = "arquivos/antes/";
    strcat(path_data, file_input_data);
    char path_index[50] = "arquivos/antes/";
    strcat(path_index, file_input_index);
    ...
    case 8:
        //RUN CODES 
        where(file_input_index, file_input_data);

        //LOCAL
        //where(path_index, path_data);
        break;
    case 9:
        scanf("%d", &n);
        // RUN CODES
